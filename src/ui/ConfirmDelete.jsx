    ...
    <div className="py-4">
      <div className="flex flex-col justify-center items-center gap-4">
        ...
        <div className="flex justify-center items-center gap-3 mt-1">
          <button disabled={isLoading} onClick={onConfirm} className={`px-4 py-2 font-bold rounded-lg text-white ${isDarkMode ? `bg-red-900 hover:bg-red-800` : `bg-red-700 hover:bg-red-600`}`}>{isLoading ? <SpinnerMini dark={false} /> : `Yes, I'm sure`}</button>
