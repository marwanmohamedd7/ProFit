...
function Open({ children, opens: opensTab, icon }) {
    ...
    return (
        <button
            ...
            className={`flex flex-col items-center justify-center gap-2 text-base ${currentActive === opensTab ? "bg-blue-700 text-white" : "hover:bg-gray-400 hover:text-white text-gray-500"} text-center cursor-pointer transition-all duration-300 font-semibold tracking-wide capitalize rounded-lg px-5 py-4`}>
