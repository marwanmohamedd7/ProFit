...
function InputTextArea({ disabled, errors, register, placeholder }) {
    const colors = styles();
    ...
    return (
        <div className="space-y-1">
            ...
            <textarea
                ...
                className={`mt-1 block w-full py-2 px-3 border rounded-md shadow-sm focus:outline-none disabled:cursor-not-allowed ${isDarkMode ? `focus:ring-blue-500 focus:border-blue-500 disabled:bg-slate-700 disabled:text-gray-200 ${colors.bg_slate_800} ${colors.border_gray_700} ${colors.text_white} placeholder:text-gray-200` :`focus:ring-blue-700 focus:border-blue-700 disabled:bg-gray-50 disabled:text-gray-600 placeholder:text-gray-500`} sm:text-sm`}
                {...register}
            />
