    ...
    return (
        <div className={`relative ${width}`}> {/* Container with relative positioning */}
            ...
            <input
                ...
                focus:outline-none focus:ring-1 focus:bg-transparent  ${isDarkMode ? `${colors.bg_white} bg-opacity-10 ${colors.text_white} ${colors.border_gray_700} focus:border-blue-500 focus:ring-blue-500` : `text-gray-900 ${backgroundColor ? backgroundColor : `${colors.bg_gray_100} ${colors.text_gray_500} focus:border-blue-600 focus:ring-blue-700`}`} border`}
