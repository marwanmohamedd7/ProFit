...
function DashboardAdminLayout() {
    ...
    const { overAllTrainers, overAllTrainees, systemUsers, subscriptionsByDate, } = getAdminDashboardData
    ...
    return (
        <div className="space-y-4">
            ...
            <Stats>
                ...
                <Stat icon={<DumbbellIcon />} color={isDarkMode ? `text-red-500 bg-red-900 bg-opacity-50` : `bg-red-100 text-red-500`} title="Total proFIT excerises" value={totalExercises} />
                <Stat icon={<AppleIcon fill={true} />} color={isDarkMode ? `text-green-500 bg-green-900 bg-opacity-50` : `bg-green-100 text-green-500`} title="Total proFIT foods" value={totalFoods} />
                <Stat icon={<UsersMoreIcon />} color={isDarkMode ? `text-indigo-500 bg-indigo-900 bg-opacity-50` : `bg-indigo-100 text-indigo-500`} title="total pending trainers" value={totalPendingTrainers} />
            </Stats>
