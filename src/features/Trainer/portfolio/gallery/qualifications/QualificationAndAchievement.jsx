    ...
    return (
        <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="relative">
                ...
                <div
                    className={`rounded-md text-gray-500 bg-gray-100 text-xs flex flex-col items-center justify-center gap-2 tracking-wide text-center border h-28 w-28 capitalize`}
                >
                    {isLoading ?
                        <SpinnerMini />
                        :
