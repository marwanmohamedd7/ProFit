...
function PerformanceHeartRate({ data }) {
    ...
    return (
        <TrainerProgressPerformanceCards detailedData={{ data: weeklyHeartRate, title: "heart rate" }} icon={<HeartIcon />} color={isDarkMode ? `text-red-500` : `text-red-600`} title="heart rate">
